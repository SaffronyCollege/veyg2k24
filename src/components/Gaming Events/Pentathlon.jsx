       ...
       LEVEL 1
        ...
        <div className="valorantmapselection w-[950px] mx-auto text-center p-5 m-mapselection">
          <div className="p-[10px] flex flex-col gap-3 text-[#D4D4D4] tracking-[1.15px] text-[20px] font-inter text-center m-map-rules">
           ...
           <li>Duration: 80 Mins</li>
  <li>All participants play the round separately.</li>
  <li>The first round includes four games: Sack race, Lame race, Cartons jump, Lemon-Spoon.</li>
  <li>Group Competition.</li>
  <li>Each group must have 4 participants.</li>
       ...
       LEVEL 2
        ...
        <div className="valorantmapselection w-[950px] mx-auto text-center p-5 m-mapselection">
          <div className="p-[10px] flex flex-col gap-3 text-[#D4D4D4] tracking-[1.15px] text-[20px] font-inter text-center m-map-rules">
            ...
            <li>The group winning all four games qualifies for the Second Round (Final Round).</li>
  <li>The group completing the Second Round Challenge in less time will be the winner.</li>
       ...
       RULES
        ...
        <div className="valorantmapselection w-[950px] mx-auto text-center p-5 m-mapselection">
          <div className="p-[10px] flex flex-col gap-3 text-[#D4D4D4] tracking-[1.15px] text-[20px] font-inter text-center m-map-rules">
            ...
            <li>In a group of 4, the team can participate.</li>
  <li>In the First Round, each game features one team member, with no repetition.</li>
  <li>Five teams play simultaneously.</li>
  <li>Maximum Time Limit for First Round Games: 80 minutes (16 minutes per 5 teams).</li>
  <li>1st Day is the First Qualifying Round; groups qualifying proceed to the 2nd Day for the Final Round.</li>
...
export default transition(Pentathlon);